...
architectures. We demonstrate in this vignette that archR's simple algorithm 
based on chunking and iterative processing successfully uncovers hidden 
clusters characterized by combinations of sequence motifs. 
...
thisConfig <- archR::archRSetConfig(innerChunkSize = 500,
                                    ...
                                    cvFolds = 3, nIterationsUse = 25,
                                    nCoresUse = NA, seedVal = 11223344)
```
...
every iteration in the lust variable `clustBasisVectors`. `clustBasisVectors` 

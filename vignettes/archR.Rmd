...
archR::viz_basis_vectors_as_seqlogo(archRresult$clustBasisVectors[[1]]$basisVectors,
                            position_labels = positions,
                            plotMethod = "bits")

archR::viz_basis_vectors_as_heatmap(archRresult$clustBasisVectors[[1]]$basisVectors,
                           position_labels = positions)
```

...
# Introduction
archR is an NMF-based unsupervised learning approach for identifying different 
core promoter architectures. 
We demonstrated that archR's simple algorithm based
on chunking and iterative processing successfully uncovers hidden clusters 
characterized by combinations of sequence motifs. 

...
test_that("Given object is matrix", {
  ...
  expect_error(viz_all_factors_in_combined_heatmaps_seqlogos(testFeaturesMat, position_labels = testPositionLabels)
               , "not of type matrix")
...
test_that("Handling empty matrix", {
  ...
  testPositionLabels <- seq(25)
  expect_error(viz_all_factors_in_combined_heatmaps_seqlogos(testFeaturesMat,
